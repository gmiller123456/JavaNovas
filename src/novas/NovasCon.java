...
public class NovasCon {

/*
   TDB Julian date of epoch J2000.0.
*/

    static final double T0 = 2451545.00000000;
...
*/
    ...
    static final double AU_SEC = 499.0047838061;

/*
   Speed of light in AU/day.  Value is 86400 / AU_SEC.
*/

    static final double C_AUDAY = 173.1446326846693;

/*
   Astronomical unit in meters.  Value is AU_SEC * C.
*/

    static final double AU = 1.4959787069098932e+11;

/*
   Astronomical Unit in kilometers.
*/

    static final double AU_KM = 1.4959787069098932e+8;
...
*/
    ...
    static final double GS = 1.32712440017987e+20;
...
*/
    ...
    static final double GE = 3.98600433e+14;

/*
   Radius of Earth in meters from IERS Conventions (2003).
*/

    static final double ERAD = 6378136.6;
...
*/
    ...
    static final double F = 0.003352819697896;
...
*/
    ...
    static final double ANGVEL = 7.2921150e-5;
...
*/
    ...
    static final double TWOPI = 6.283185307179586476925287;

/*
   Number of arcseconds in 360 degrees.
*/

    static final double ASEC360 = 1296000.0;

/*
   Angle conversion constants.
*/

    static final double ASEC2RAD = 4.848136811095359935899141e-6;
    static final double DEG2RAD = 0.017453292519943296;
    static final double RAD2DEG = 57.295779513082321;
